...
from pyibisami.ami.reserved import RESERVED_PARAM_NAMES
...
def proc_branch(branch):
    ...
    try:
        ...
        logger.error(f"Error processing branch:\n{param_tags}")
    return results
            ...
            param_dict:
                ...
                structure::

                    {
                        ...
                        'Reserved_Parameters'   :   <dictionary of reserved parameter definitions>
